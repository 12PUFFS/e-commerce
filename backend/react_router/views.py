...
def products_list(request):
    ...
    return JsonResponse({'products': list(products_qs)}, safe=False)


# Данные о товарах (оставлены как резервная копия, закомментированы)
# products = [
#   {
#     'id': 1,
...
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки NIKE Air Force 1 - это стильная и универсальная модель...',
#     'photos': [
...
#     'price': '14 912',
#     'image': 'https://avatars.mds.yandex.net/get-mpic/986077/2a00000192ec444afcccb0f62be69d2aa8fa/900x1200',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки NIKE Air Force 1 - это стильная и универсальная модель',
#     'photos': [
...
#     'price': '23 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/590/666_666_1/p538b44xjtftpk2rir04vpoxwme0ummz.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки Nike Dunk Low Retro - это стильная и универсальная модель, они отлично подходят для повседневной носки. Классический дизайн никогда не выходит из моды.',
#     'photos': [
...
#     'price': '15 699',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/fc7/666_666_1/c4srpa17570frxj8zq5ffve1bu535h35.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки adidas Superstar впервые вышли на баскетбольные площадки в 1970 году. Прошло совсем немного времени, прежде чем они превратились из обуви для спортсменов в икону уличной моды. Модель adidas Superstar II выполнена в том же стиле, с теми же пропорциями и из тех же материалов, которые сделали оригинальную модель легендой. Верх из гладкой кожи дополнен спортивными тремя полосками и накладкой на пятке. Финальный штрих — классический резиновый мысок-ракушка.',
#     'photos': [
#       'https://static.street-beat.ru/upload/resize_cache/iblock/fc7/666_666_1/c4srpa17570frxj8zq5ffve1bu535h35.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/b82/666_666_1/gycjlprpgx9ceu3a41egae4a4nvw7e1y.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/406/666_666_1/w7z1h6fbizpmktuoeyr99lhi9i07sv81.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/ea2/666_666_1/8r2nqhnhqm1bnl9ff4byz75r7pkmbadx.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/850/666_666_1/2x6nnjx3qbm1pblc3ym9wx4hj99x3vh4.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/c23/666_666_1/8nhh7sqydp7jrop7ztrgvru5jpokzmye.jpg',
#     ],
#     'desc': [
#       'Низкий силуэт',
#       'Кожаный верх',
...
#     'price': '12 199',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/f1d/666_666_1/o9qpmny0f4rtu8uhrw5cbz0i35mhit0z.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки adidas Superstar впервые вышли на баскетбольные площадки в 1970 году. Прошло совсем немного времени, прежде чем они превратились из обуви для спортсменов в икону уличной моды. Модель adidas Superstar II выполнена в том же стиле, с теми же пропорциями и из тех же материалов, которые сделали оригинальную модель легендой. Верх из гладкой кожи дополнен спортивными тремя полосками и накладкой на пятке. Финальный штрих — классический резиновый мысок-ракушка.',
#     'photos': [
...
#     'price': '15 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/2f4/666_666_1/pl7ot405u9m6gbfwmqnauqe2azn5wbas.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'shoes',
#     'fulldesc': 'Кроссовки adidas Superstar впервые вышли на баскетбольные площадки в 1970 году. Прошло совсем немного времени, прежде чем они превратились из обуви для спортсменов в икону уличной моды. Модель adidas Superstar II выполнена в том же стиле, с теми же пропорциями и из тех же материалов, которые сделали оригинальную модель легендой. Верх из гладкой кожи дополнен спортивными тремя полосками и накладкой на пятке. Финальный штрих — классический резиновый мысок-ракушка.',
#     'photos': [
...
#     'price': '47 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/9f7/666_666_1/mdctb3fonrzca9plhi52agxq8r3stz4r.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'clothing',
#     'fulldesc': 'Культовый силуэт, рожденный для покорения восьмитысячников и адаптированный для динамичного ритма мегаполиса. Пуховик Regrind Himalayan Down Jacket от The North Face — это безупречное сочетание архивного наследия бренда и современных экологичных технологий.',
#     'photos': [
...
#     'title': 'The North Face Retro Nuptse Jacket',
#     'price': '37 799',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/f2e/666_666_1/0a5wvos1c65c7aibuixif911em5yrwt8.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'clothing',
#     'fulldesc': 'Большие дутые отсеки, оригинальные цветовые решения и эталонное качество — всё это культовый пуховик Retro Nuptse Jacket. Немного укороченный силуэт модели отсылает нас к истории её создания, когда альпинистам было необходимо носить поясной ремень со снаряжением. Верхний слой куртки выполнен в стиле колор-блок из рипстоп-нейлона с водоотталкивающей пропиткой. В качестве утеплителя — гусиный пух, собранный по стандартам ответственного потребления. Эластичные манжеты и нижний край обеспечивают плотное прилегание и отличную посадку по фигуре. В воротнике спрятан лёгкий капюшон с козырьком. Собираясь в путешествие, вы можете сложить куртку в один из её карманов.',
#     'photos': [
...
#     'price': '6 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/1db/666_666_1/tf3wtszch5up14ygfxvrtvc4w3axv8vd.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Мужская футболка Carhartt WIP Chase T-Shirt выполнена из натурального хлопка. Материал отлично циркулирует воздух. Свободный крой не сковывает движения. Модель дополнена вышитым логотипом бренда.',
#     'photos': [
...
#     'title': 'Carhartt WIP Chase T-Shirt',
#     'price': '6 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/ae2/666_666_1/6t017b2f6dcq7u5on1gjtjjbrfc2ococ.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Мужская футболка Carhartt WIP Chase T-Shirt выполнена из натурального хлопка. Материал отлично циркулирует воздух. Свободный крой не сковывает движения. Модель дополнена вышитым логотипом бренда.',
#     'photos': [
...
#     'price': '17 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/efb/666_666_1/32n6ak93wz0bg2mfvv0t9y5vd7fqklqj.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'Pant',
#     'fulldesc': 'Мужские штаны Carhartt WIP Landon Pant выполнены из натурального хлопка. Свободный крой не сковывает движения. Модель дополнена вышитым логотипом бренда.',
#     'photos': [
...
#     'price': '17 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/980/666_666_1/rbhr2r91rp2d6jjokkwh17jml5a1bcuy.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'Pant',
#     'fulldesc': 'Мужские штаны Carhartt WIP Brandon Pant выполнены из натурального хлопка. Свободный крой не сковывает движения. Модель дополнена вышитым логотипом бренда.',
#     'photos': [
...
#     'title': 'The North Face Retro Nuptse Jacket',
#     'price': '37 799',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/a00/666_666_1/amy83q2zbsgsl6fo0ihmxyddz5h5b37w.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'clothing',
#     'fulldesc': 'Культовый силуэт, рожденный для покорения восьмитысячников и адаптированный для динамичного ритма мегаполиса. Пуховик Regrind Himalayan Down Jacket от The North Face — это безупречное сочетание архивного наследия бренда и современных экологичных технологий.',
#     'photos': [
...
#     'title': 'The North Face Retro Nuptse Jacket',
#     'price': '37 799',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/f19/666_666_1/xq12zjn27nnhze6dkgzxvc9bmuscvu6t.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'clothing',
#     'fulldesc': 'Культовый силуэт, рожденный для покорения восьмитысячников и адаптированный для динамичного ритма мегаполиса. Пуховик Regrind Himalayan Down Jacket от The North Face — это безупречное сочетание архивного наследия бренда и современных экологичных технологий.',
#     'photos': [
...
#     'price': '10 499',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/7f9/666_666_1/nsjq75iao2k9jr5wgwjx6jb7l5q0clmw.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'Pant',
#     'fulldesc': 'Культовый силуэт, рожденный для покорения восьмитысячников и адаптированный для динамичного ритма мегаполиса. Пуховик Regrind Himalayan Down Jacket от The North Face — это безупречное сочетание архивного наследия бренда и современных экологичных технологий.',
#     'photos': [
...
#     'title': 'Carhartt WIP Brandon Pant',
#     'price': '17 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/2d2/666_666_1/stq2jy1vajo9jbwogou7tbhwed1ycjq0.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'Pant',
#     'fulldesc': 'Культовый силуэт, рожденный для покорения восьмитысячников и адаптированный для динамичного ритма мегаполиса. Пуховик Regrind Himalayan Down Jacket от The North Face — это безупречное сочетание архивного наследия бренда и современных экологичных технологий.',
#     'photos': [
...
#     'price': '8 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/eb6/666_666_1/2vakmmku4e4ws10cj8x0srgzq61a3kuh.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Женская футболка Carhartt WIP Benton Tee выполнена из органического хлопка. Материал приятен к телу и отлично циркулирует воздух. Ткань окрашена в готовом виде для большей мягкости и сложной цветовой гаммы.',
#     'photos': [
...
#     'title': 'Carhartt WIP Benton Tee',
#     'price': '8 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/9cc/666_666_1/qzt8bqiry1alnt585a9j9nd0p6qdwfzv.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Женская футболка Carhartt WIP Benton Tee выполнена из органического хлопка. Материал приятен к телу и отлично циркулирует воздух. Ткань окрашена в готовом виде для большей мягкости и сложной цветовой гаммы.',
#     'photos': [
...
#     'price': '3 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/bc8/666_666_1/gabvu1ndd2895m6pqgn7iir0be736tav.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Женская футболка adidas Regular Tee — классика спортивной моды. Она выполнена из натурального хлопка и дополнена вышитым логотипом — трилистником adidas.',
#     'photos': [
...
#     'price': '3 999',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/c3f/666_666_1/081o5we04lwo3vv06a5p6iqgqn5saoq2.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'T-Shirt',
#     'fulldesc': 'Футболка расслабленного кроя adidas Essentials Boyfriend Tee. Модель выполнена из плотной хлопковой ткани. Материал приятен к телу и отлично циркулирует воздух. Футболка дополнена вышитым логотипом adidas.',
#     'photos': [
...
#   {
#     'id': 26,
#     'title': 'The North Face Essential Light Relaxed Hoodie',
#     'price': '8 499',
#     'image': 'https://static.street-beat.ru/upload/resize_cache/iblock/5ff/666_666_1/fjqng9yg8439pvt8vxqbvib2d97j2m69.jpg',
#     'description': 'Классические кроссовки в ретро-стиле с удобной амортизацией',
#     'category': 'hudi',
#     'fulldesc': 'Худи The North Face Essential Light Relaxed Hoodie создана из мягкого хлопка. Материал приятен к телу и отлично циркулирует воздух. Эластичные манжеты и нижний край обеспечивают комфортную посадку. Капюшон защищает от ветра. Есть карман, в который можно прятать руки.',
#     'photos': [
#       'https://static.street-beat.ru/upload/resize_cache/iblock/5ff/666_666_1/fjqng9yg8439pvt8vxqbvib2d97j2m69.jpg',
#       'https://static.street-beat.ru/upload/resize_cache/iblock/3f9/666_666_1/foe7m4fz94s26190wzq5yksonrcosju6.jpg'
#     ],
#     'desc': [
#       'Свободный крой',
#       'Мягкий трикотаж',
#       'Карман-кенгуру',
#       'Эластичные манжеты и нижний край модели',
#       'Капюшон на шнуровке',
#       'Логотип бренда'
#     ],
#     'variants': [],
